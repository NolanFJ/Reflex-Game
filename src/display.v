...
module display (
    ...
    always @ (*) begin
        case (digit_select)
            2'b11: an = 4'b1110;  // Enable an[0] (leftmost)
            2'b10: an = 4'b1101;  // Enable an[1]
            2'b01: an = 4'b1011;  // Enable an[2]
            2'b00: an = 4'b0111;  // Enable an[3] (rightmost)
        endcase
    end
